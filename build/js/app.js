...
var Application = React.createClass({
  ...
  render: function render() {
    return React.createElement(RouteHandler, { params: this.props.params });
  }
});
...
var routes = React.createElement(
  ...
  React.createElement(DefaultRoute, { path: '/youtube-annotation/', name: 'uploadAndView', handler: UploadAndView }),
...
},{"./components/NotFound.react":200,"./components/UploadAndView.react":202,"react":197,"react-router":28}],2:[function(require,module,exports){
...
var Annotation = React.createClass({
  ...
  render: function render() {
    ...
    return React.createElement(
      'div',
      { style: textStyle },
      data[elapsedTime] ? data[elapsedTime] : React.createElement(
        'span',
        { style: noAnnotationStyle },
        'No annotation.'
      )
    );
  }
...
var Upload = React.createClass({
  ...
  handleDrop: function handleDrop(dataTransfer) {
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'h2',
            { style: h2Style },
            '1. Drag and drop your annotation in JSON file:'
          ),
          React.createElement(JsonFormatExample, { data: this.state.data }),
          React.createElement(
            'h2',
            { style: h2Style },
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                'form',
                { className: 'form-inline', style: formStyle, onSubmit: this.handleSubmit },
                React.createElement(
                  'div',
                  { className: 'form-group' },
                  React.createElement('input', { type: 'text', className: 'form-control input-lg', value: this.state.videoId, onChange: this.handleInputChange })
                ),
                React.createElement(
                  'button',
                  { type: 'submit', className: 'btn btn-default btn-danger btn-lg', style: buttonStyle },
                  'Play'
                )
              )
            )
...
},{"./JsonFormatExample.react":199,"react":197,"react-file-drag-and-drop":3}],202:[function(require,module,exports){
'use strict';
...
var UploadAndView = React.createClass({
  ...
  handlePlay: function handlePlay(videoId, data) {
    this.setState({
      isPlaying: true,
      data: data,
      videoId: videoId
  ...
  render: function render() {
    if (this.state.isPlaying) {
      return React.createElement(View, { videoId: this.state.videoId, data: this.state.data });
    } else {
      return React.createElement(Upload, { onPlay: this.handlePlay });
    }
  }
});
...
},{"./Upload.react":201,"./View.react":204,"react":197}],203:[function(require,module,exports){
'use strict';
...
var Video = React.createClass({
  ...
  handleOnYouTubeIframeAPIReady: function handleOnYouTubeIframeAPIReady() {
    /*
  ...
  loadIFrameAPIAsynchronously: function loadIFrameAPIAsynchronously() {
...
var View = React.createClass({
  ...
  onElapsedTimeChange: function onElapsedTimeChange(elapsedTime) {
    this.setState({
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'div',
            { className: 'col-md-8', style: containerStyle },
            React.createElement(
              'div',
              { className: 'row', style: containerStyle },
          ...
          React.createElement(
            'div',
            { className: 'col-md-4' },
            this.state.isPlayerReady ? React.createElement(Annotation, { elapsedTime: this.state.elapsedTime, data: this.props.data }) : null
          )
        )
      )
    );
...
},{"./Annotation.react":198,"./Video.react":203,"react":197}]},{},[1]);
