...
var routes = (
  React.createElement(Route, {name: "application", path: "/", handler: Application}, 
  ...
  render: function () {
    ...
    return (
      React.createElement("div", {style: textStyle}, 
        data[elapsedTime] ? data[elapsedTime]: React.createElement("span", {style: noAnnotationStyle}, "No annotation.")
      )
    );
  }
});
...
var JsonFormatExample = React.createClass({displayName: "JsonFormatExample",
  render: function () {
  ...
  render: function () {
    ...
    return (
      React.createElement("div", {className: "container text-center"}, 
        React.createElement("h2", {style: h2Style}, 
  ...
  render: function () {
    ...
    return (
      React.createElement("div", {style: containerStyle}, 
        React.createElement(FileDragAndDrop, {onDrop: this.handleDrop}, 
          React.createElement("div", {className: "container-fluid", style: containerStyle}, 

            React.createElement("h2", {style: h2Style}, "1. Drag and drop your JSON file"), 

            React.createElement(JsonFormatExample, {data: this.state.data}), 

            React.createElement("h2", {style: h2Style}, "2. Tell YouTube video id:"), 

            React.createElement("div", {className: "row"}, 
              React.createElement("div", {className: "col-md-2 col-md-offset-5 text-center"}, 

                React.createElement("input", {type: "text", className: "form-control input-lg", placeholder: "", value: this.state.videoId, onChange: this.handleInputChange}), 
                React.createElement("button", {className: "btn btn-default", onClick: this.handleClick}, "Play")
...
var UploadAndView = React.createClass({displayName: "UploadAndView",
  ...
  render: function () {
    if (this.state.isPlaying) {
      return (
        React.createElement(View, {videoId: this.state.videoId, data: this.state.data})
      );
    } else {
      return (
        React.createElement(Upload, {onPlay: this.handlePlay})
      );
    }
  }
});
      ...
      React.createElement("div", {style: containerStyle}, 
        React.createElement("div", {className: "container-fluid", style: containerStyle}, 
          React.createElement("div", {className: "row", style: containerStyle}, 
            React.createElement("div", {className: "col-md-8", style: containerStyle}, 
              React.createElement("div", {className: "row", style: containerStyle}, 
            ...
            React.createElement("div", {className: "col-md-4"}, 
                ...
                React.createElement(Annotation, {elapsedTime: this.state.elapsedTime, data: this.props.data})
                : null
